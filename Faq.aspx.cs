...
public partial class Faq : System.Web.UI.Page
{
    ...
    protected void btnGui_Click(object sender, EventArgs e)
    {
        ...
        if (result == 1)
        {
            Response.Write("<script>alert('Gửi câu hỏi thành công. Trung tâm sẽ cố gắng liên hệ sớm nhất có thể với bạn. Cảm ơn bạn. Chúc bạn một ngày làm việc vui vẻ. Have Fun !')</script>");
            ResetTextbox();
        }
    }
}