<%@ Page Title="Khai Giảng ASEC Juniors | Trung Tâm Ngoại Ngữ Chân Trời Mới" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="KG_Juniors.aspx.cs" Inherits="KG_Juniors" %>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <h2 class="title-page">ASEC Juniors</h2>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <asp:Repeater ID="rpASEC_Juniors" runat="server">
                                    <ItemTemplate>
